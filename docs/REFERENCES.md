...
### Canary research repository
https://github.com/Hokz/canary

Use as a research source for:
- combat formulas;
- creatures;
- items;
- vocation systems;
...
Do not automatically reuse Canary as the Idle backend.
...
1. official source;
2. reproducible current empirical behavior;
3. multiple credible community sources;
