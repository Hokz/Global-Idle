...
| `docs/specs/phase-3-5/PHASE_3_5_IMPLEMENTATION_NOTES.md` | **Phase 3.5 notes** — the doorway deadlock the budgets were hiding, what the browser found that reasoning did not, and the self-review |
