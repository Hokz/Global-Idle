...
- **Party & Character Roster System Foundation**
  ...
  - amended again 2026-09-25, final synchronization: companions are **permanent**; the vocation chosen on proceeding to the Mainland is the Main's; no hidden Main / companion multiplier; deletion takes the whole Game Account (`ADR-024`).
