...
Active phase: **Phase 3.7 — First real asset visual slice** (`PLANNED`). No specification exists
yet, and nothing in it may be treated as designed, let alone accepted.
